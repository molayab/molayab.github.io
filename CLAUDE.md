...
- **Creating a new post**: see `AGENTS.md` for the step-by-step (front matter fields, file naming, local preview). Permalinks are `/blog/:year/:month/:day/:title/` (set in `_config.yml`).
